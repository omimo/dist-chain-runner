...
def send_photo(index, name, code_id1, code_id2, org_file, p1_out_file):
    ...
    with open(org_file, 'rb') as _org_img_file,  open(p1_out_file, 'rb') as _p1_out_img_file:
        files={
            'org_file': _org_img_file,
            'p1_out_file': _p1_out_img_file
        }
